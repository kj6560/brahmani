			...
			<section class="process-section-two">
				<div class="container">
					...
					<div class="pbmit-text-editor">
						<span class="pbmit-text-design">Hurry</span>  Let’s make something great work together. Got a project in mind? <span class="pbmit-globalcolor"><u>Contact us now</u></span>
					</div>
				</div>
			</section>
			<!-- Process End -->
