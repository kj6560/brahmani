...
<div class="content-wrapper">
    <div class="row">
        <div class="col-md-11 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{!empty($page) && $page->id ? "Edit" : "Create"}} City Wise Page
                        {{!empty($page->page_name) ? " : " . $page->page_name : ""}}
                    </h4>
                    @include('backend.errors.formErrors')
                    <form method="POST" action="/admin/categories/storeBulkPages/city" enctype="multipart/form-data"
                        class="forms-sample">
